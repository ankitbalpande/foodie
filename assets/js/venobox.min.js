! function(e, t) {
     ...
     */
    let e, t, o, n, s, i, a, r, l, d, c, v, u, b, p, g, f, m, y, x, h, L, w, k, S, C, A, E, P, q, M, T, j, H, O, z, B;
    ...
    function U(e) {
        if (!e) return !1;
        y = !0, r = e, L = !1, w = !1, S = e.getAttribute("data-maxwidth") || e.settings.maxWidth, C = e.getAttribute("data-overlay") || e.settings.overlayColor, A = e.getAttribute("data-ratio") || e.settings.ratio, E = e.getAttribute("data-autoplay") || e.settings.autoplay, P = e.getAttribute("data-href") || e.getAttribute("href"), q = e.getAttribute("data-customclass") || e.settings.customClass, z = e.getAttribute(e.settings.titleattr) || "", H = e.getAttribute("data-border") || e.settings.border
    }

    function Z() {
        return !(!r || !document.body.classList.contains("vbox-open")) && ((!r.settings.onPreClose || "function" != typeof r.settings.onPreClose || (r.settings.onPreClose(r, p, T, j), !1 !== r.settings.onPreClose)) && (document.body.removeEventListener("keydown", J), document.body.classList.remove("vbox-open"), r.focus(), void K({
            duration: 200,
            timing: F,
            draw: function(e) {
    ...
    function J(e) {
        27 === e.keyCode && Z(), B || (37 == e.keyCode && !0 === w && le(j), 39 == e.keyCode && !0 === L && le(T), B = setTimeout((() => {
            B = null
        }), 100))
    }
    ...
    function ee(e, t, o) {
        let n;
        if (a.classList.add("vbox-loading"), -1 !== e.search(/.+\.mp4|og[gv]|webm/)) n = o ? " autoplay" : "", x = '<div class="venoratio venoratio-' + t + '"><video src="' + e + '"' + n + " controls>Your browser does not support the video tag.</video></div>";
        else {
            let s, i = function(e) {
                let t, o, n;
            ...
            "vimeo" == i.type ? s = "https://player.vimeo.com/video/" : "youtube" == i.type && (s = "https://www.youtube.com/embed/"), x = '<div class="venoratio venoratio-' + t + '"><iframe webkitallowfullscreen mozallowfullscreen allowfullscreen allow="autoplay" frameborder="0" src="' + s + i.id + a + '"></iframe></div>'
        }
        ...
        if (e = x, I.innerHTML = e, g = I.querySelectorAll("img"), g.length) {
            ...
            Y(g, (function(t) {
                ...
                R = new Image, R.onload = function() {
                    e++, e == g.length && (a.classList.remove("vbox-loading"), $("animated"))
                }, R.onerror = function() {
                    e++, e == g.length && (a.classList.remove("vbox-loading"), $("animated"))
                }, R.src = o
            }))
    ...
    function oe(e) {
        if (!y) {
            ...
            a.style.transition = "margin " + t + "ms ease-out, opacity " + t + "ms ease-out", M = v = e.pageY, V = D = e.pageX, Q = !0
        }
    }
    ...
    function ne(e) {
        if (Q) {
            ...
            let e = r,
                t = !1;
            N = D - V, N < 0 && L && (e = T, t = !0), N > 0 && w && (e = j, t = !0), Math.abs(N) >= 50 && t ? le(e) : (a.style.marginLeft = 0, a.style.opacity = 1)
        }
    }
    ...
    function re() {
        ...
        switch (r.dataset.vbtype) {
            case "iframe":
                e = P, t = A, a.classList.add("vbox-loading"), x = '<div class="venoratio venoratio-' + t + '"><iframe src="' + e + '"></iframe></div>', a.classList.remove("vbox-loading"), $("animated");
                break;
            case "inline":
                ! function(e) {
                    let t = document.querySelector(e);
                    t && (a.classList.add("vbox-loading"), x = '<div class="vbox-inline">' + t.innerHTML + "</div>", a.classList.remove("vbox-loading"), $("animated"))
                }(P);
                break;
            case "ajax":
                ! function(e) {
                    ...
                    t.open("GET", e, !0), t.onload = function() {
                        ...
                        x = '<div class="vbox-inline"></div>', a.classList.remove("vbox-loading"), $("animated")
                    }, t.send()
                }(P);
                break;
            case "video":
            ...
            default:
                ! function(e) {
                    R.onload = function() {
                        x = '<div class="vbox-child"><img src="' + e + '"></div>', a.classList.remove("vbox-loading"), $("animated")
                    }, R.src = e
                }(P)
        }
        var e, t
    ...
    function le(e) {
        ...
        a.classList.add("vbox-animated", "vbox-loading"), ie(e), K({
            duration: r.settings.navSpeed,
            timing: F,
            draw: function(e) {
                a.style.opacity = o - e / o, 1 === e && (a.classList.remove("swipe-left", "swipe-right", "vbox-animated"), a.style.marginLeft = 0, a.style.transition = "", $("loading"), y = !1, r.settings.onNavComplete && "function" == typeof r.settings.onNavComplete && r.settings.onNavComplete(r, p, T, j))
            }
        }), re()
    }

    function de(l) {
        return !(document.body.classList.contains("vbox-open") || !l) && (l.settings.onPreOpen && "function" == typeof l.settings.onPreOpen && l.settings.onPreOpen(l), !!l.settings.onPreOpen && (U(l), document.body.insertAdjacentHTML("beforeend", s), document.body.classList.add("vbox-open"), k = document.querySelector(".vbox-overlay"), e = k.querySelector(".vbox-backdrop"), i = k.querySelector(".vbox-container"), a = i.querySelector(".vbox-content"), t = k.querySelector(".vbox-num"), o = k.querySelector(".vbox-share"), n = k.querySelector(".vbox-title"), u = k.querySelector(".vbox-preloader"), b = u.querySelector(".vbox-preloader-inner"), k.style.opacity = 0, ae(l), ie(l), a.classList.add("vbox-animated", "vbox-loading"), K({
            duration: 200,
            timing: F,
            draw: function(e) {
                k.style.opacity = e, 1 === e && (a.classList.remove("vbox-animated"), y = !1, $("loading"), r.settings.onPostOpen && "function" == typeof r.settings.onPostOpen && r.settings.onPostOpen(r, p, T, j))
            }
        }), re(), l.settings.navKeyboard && (document.body.addEventListener("keydown", J), document.body.addEventListener("keyup", (() => {
    ...
    const ce = function(e) {
        ...
        return t.close = Z, t.next = _, t.prev = G, t.open = de, t.settings = o,
            function(e, t) {
